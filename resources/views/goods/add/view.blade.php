...
@section('title', 'EC管理システム-新規登録-確認画面')
@section('content')
...
{{-- 商品情報入力フォーム --}}
 <form action="{{route('goods_add_do')}}" method="post">
 ...
 <input type="hidden" name="intro_txt" value="{!! nl2br(e(request()->intro_txt)) !!}">
...
<button type="submit" onClick="submitAction('{{route('goods_add')}}','get')" class="d-inline-block">商品情報入力へ戻る</button> 
